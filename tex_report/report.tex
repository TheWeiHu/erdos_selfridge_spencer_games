...
%
%\begin{enumerate}
% \item Is playing "greedily" every turn really the best approach? Find proof for actual optimal play.
% \item Introduce ESS Games, and mention how our variety cares about how many pieces get promoted rather than whether any piece gets promoted.
%  \item Proofs about random defenders, splitting lemma etc (from previous type-up).
%  \item Learn to make LaTeX bibliographies.
%  \item Learn to make use of Amazon Web Server.
%  \item Change >= to \geq
%\end{enumerate}
